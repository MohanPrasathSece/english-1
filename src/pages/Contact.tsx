...
const Contact = ({ user }: ContactProps) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.alreadyExists) {
        toast.info(data.message || "It looks like you've already contacted us.");
      } else {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        title="Contact Asset Circle — Digital Asset Enquiries"
        description="Get in touch with the Asset Circle team regarding digital asset custody, yield optimization, or investment enquiries."
        canonical="/contact"
      />

      {/* Hero banner */}
      <div className="relative py-32 flex items-center justify-center overflow-hidden border-b border-border bg-gradient-to-b from-primary/5 to-background">
        <div className="relative z-10 text-center px-6">
          <p className="text-xs font-semibold text-primary uppercase tracking-widest mb-3">Get In Touch</p>
          <h1 className="text-4xl md:text-5xl font-extrabold text-foreground mb-4">Contact Our Desk</h1>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Our team of digital asset specialists is available to assist you with any enquiry.
          </p>
        </div>
      </div>
              ...
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@assetcircle.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                      support@assetcircle.com
                    </a>
                  </div>
                </div>
              </div>
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Our team responds within 24 business hours.</p>
                  </div>
                </div>
              </div>
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground mb-1">Common Questions</p>
                ...
                <form id="contact-form" onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-muted-foreground uppercase mb-2">
                      Message <span className="text-muted-foreground/60 normal-case">(optional)</span>
                    </label>
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="sm:max-w-md text-center p-8 bg-card border border-border">
          <div className="flex flex-col items-center gap-4">
            ...
            <DialogHeader>
              <DialogTitle className="text-2xl text-center text-foreground">Enquiry Received</DialogTitle>
              <DialogDescription className="text-center text-muted-foreground pt-2">
                Thank you for reaching out. An Asset Circle specialist will contact you shortly.
              </DialogDescription>
            </DialogHeader>
